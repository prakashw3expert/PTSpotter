             ...
             TODAYS SCHEDULE
               ...
               <List  dataArray={this.state.results.items} renderRow={(item) =>
                     <ListItem button avatar style={{marginBottom:5}}>
                         <Left>
                           {item.last === false ? <Thumbnail source={item.image} style={{width:50, height:50}} /> : <Badge primary style={{width:50, height : 50, borderRadius : 50, backgroundColor:'rgb(172, 14, 250)', padding:7, paddingTop:15, paddingLeft:20}}><Text style={{fontSize:16, color:'white', fontFamily:Fonts.style.bold}}>6</Text></Badge>}
                         </Left>
